...
function read_version () {
    ...
    VERSION=$(kubectl get deployments akvo-authz-unilog-consumer -o jsonpath="{@.spec.template.metadata.labels['akvo-authz-version']}")
}
...
log "See https://github.com/akvo/akvo-authorization/compare/$PROD_VERSION..$TEST_VERSION"
